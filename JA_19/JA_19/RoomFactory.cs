    ...
    public static class RoomFactory
    {
        ...
        public static Dictionary<RoomType, RoomSettings> CreateRoomSettingsDictionary()
        {
            return new Dictionary<RoomType, RoomSettings>()
           {
                ...
                {RoomType.Livingroom, new RoomSettings(6, 6, 9, 10, 2, 3, Settings.LivingroomKey)},
        ...
        public static Room CreateRandomRoom()
        {
            ...
            Room room = new Room(new Vector2(10, 10), roomSize, settings.TypeKey, r);
