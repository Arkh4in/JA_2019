    ...
    public static class RoomFactory
    {
        ...
        public static Dictionary<RoomType, RoomSettings> CreateRoomSettingsDictionary()
        {
            return new Dictionary<RoomType, RoomSettings>()
           {
                ...
                {RoomType.Bathroom,   new RoomSettings(4, 4, 5, 5, 1, 2, Settings.TestRoomKey)},
                {RoomType.Livingroom, new RoomSettings(6, 6, 9, 30, 1, 3, Settings.TestRoomKey)},
                {RoomType.Kitchen,    new RoomSettings(5, 5, 6, 6, 1, 2, Settings.TestRoomKey)},
                {RoomType.Garden,     new RoomSettings(7, 7, 30, 30, 2, 3, Settings.TestRoomKey)},
                {RoomType.Corridor,   new RoomSettings(3, 6, 4, 30, 2, 4, Settings.TestRoomKey)},
                {RoomType.Toilets,    new RoomSettings(3, 3, 4, 4, 1, 1, Settings.TestRoomKey)},
                {RoomType.Officeroom, new RoomSettings(4, 4, 5, 5, 1, 2, Settings.TestRoomKey)},
           };
        }
